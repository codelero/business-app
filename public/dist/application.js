...
var ApplicationConfiguration = (function () {
  ...
  var applicationModuleVendorDependencies = ['ngResource', 'ngAnimate', 'ui.router', 'ui.bootstrap', 'ui.mask', 'toaster', 'angularFileUpload', 'angularCharts'];
...
angular.module('charts').config(['$stateProvider', function ($stateProvider) {
  $stateProvider
    .state('charts', {
      ...
      resolve: {
        productItems: ["Products", function (Products) {
...
angular.module('core').config(["$provide", function ($provide) {
...
angular.module('products').factory('ProductsUtilities', [
  function () {
